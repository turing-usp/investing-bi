...
def get_portfolio_prices(stocks, funds, etfs, start_date, end_date=today):
    ...
    data_frames_stocks = get_assets_data_frames(stocks, inv.get_stock_historical_data, 'brazil', start_date=start_date, end_date=end_date)
    data_frames_funds = get_assets_data_frames(funds, inv.get_fund_historical_data, 'brazil', start_date=start_date, end_date=end_date)
    data_frames_etfs = get_assets_data_frames(etfs, inv.get_etf_historical_data, 'brazil', start_date=start_date, end_date=end_date)
